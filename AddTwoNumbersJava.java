...
public class AddTwoNumbersJava {  
	public static void main(String args[])
	{
		...
		System.out.println(" Sum of 0 and 0 is : " + add(10, 0));
	...
	/** Adding two number without using + or plus arithmetic operator using  * recursion in Java. This method uses XOR and AND bitwise operator to  * calculate sum of two numbers;*/
	...
	/** Adding two integers without any arithmetic operator and using recursion.  * This solution also uses XOR and AND bitwise and << left shift bitshift  * operator*/
